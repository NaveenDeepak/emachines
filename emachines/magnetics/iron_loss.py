# AUTOGENERATED! DO NOT EDIT! File to edit: ../../nbs/03_iron_loss.ipynb.

# %% ../../nbs/03_iron_loss.ipynb #nbdev-ca2a56
...
# %% ../../nbs/03_iron_loss.ipynb #d0843672
def steinmetz(
    f: float | np.ndarray,
...
# %% ../../nbs/03_iron_loss.ipynb #b9bfbdbd
...
# %% ../../nbs/03_iron_loss.ipynb #2f904fdf
def bertotti(
    f: float | np.ndarray,
    B_peak: float | np.ndarray,
    k_h: float,
...
# %% ../../nbs/03_iron_loss.ipynb #cc991a12
def fit_steinmetz(
    f_arr: np.ndarray,
    B_arr: np.ndarray,
    loss_arr: np.ndarray,
...
# %% ../../nbs/03_iron_loss.ipynb #nbdev-4f3887
MODEL_NAMES = ("Bertotti", "Steinmetz", "Modified Steinmetz")

# %% ../../nbs/03_iron_loss.ipynb #nbdev-58b1da
...
# %% ../../nbs/03_iron_loss.ipynb #nbdev-928365
...
# %% ../../nbs/03_iron_loss.ipynb #nbdev-3f4a60
def fit_bertotti(
    f_arr: np.ndarray,
    B_arr: np.ndarray,
    loss_arr: np.ndarray,
...
# %% ../../nbs/03_iron_loss.ipynb #nbdev-31dfd2
def fit_loss_model(
    f_arr: np.ndarray,
    B_arr: np.ndarray,
    loss_arr: np.ndarray,
